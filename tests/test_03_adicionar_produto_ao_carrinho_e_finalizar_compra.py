...
### Adding Red Tshirt to trolley (scrolling into view)

add_red_tshirt = driver.find_element(By.XPATH, "//*[contains(@class, 'inventory_item_name') and text()='Test.allTheThings() T-Shirt (Red)']")
driver.execute_script("arguments[0].scrollIntoView(true);", add_red_tshirt)
add_red_tshirt.click()

driver.find_element(By.XPATH, "//button[contains(@id, 'add-to-cart')]").click()

### ASSERTing Red Tshirt in trolley

driver.find_element(By.XPATH, "//a[@class='shopping_cart_link']").click()

assert driver.find_element(By.XPATH, "//*[contains(@class, 'inventory_item_name') and text()='Test.allTheThings() T-Shirt (Red)']").is_displayed()


### Completing purchase with one item.
